...
<div id="wrap-vp">
	<div id="header-vp">
    	<div id="logo"><img src="./public/images/logo.gif" /></div>
    </div>
    
    <div id="menu-vp">
    	<?php  require "./MVC/Views/blocks/menu.php"; ?>
    </div>
      <div id="midheader-vp">
    	<div id="left">
        ...
        <div id="right">
            ...
            <?php  require "./MVC/Views/blocks/thongtinchung.php"; ?>
        </div>
    </div>
    <div class="clear"></div>
    ...
    <div id="slide-vp">
        ...
        <?php  require "./MVC/Views/blocks/top_trang_chu.php"; ?>

        <div id="slide-right">
        <!--blocks/quangcao_top_phai.php-->
        <?php  require "./MVC/Views/blocks/quangcao_top_phai.php"; ?>
        </div>
    </div>
  	...
  	<div id="content-vp">
    	<div id="content-left">
		<!--blocks/cot_trai.php-->
        <?php  require "./MVC/Views/blocks/cot_trai.php"; ?>
        </div>
        <div id="content-main">
		...
		<!--blocks/cot_phai.php-->
        <?php  require "./MVC/Views/blocks/cot_phai.php"; ?>
        </div>
    ...
    <div class="clear"></div>
     ...
     <div id="thongtin">
        ...
        <?php  require "./MVC/Views/blocks/thongtindoanhnghiep.php"; ?>
    </div>
    <div class="clear"></div>
    <div id="footer">
    	<!--blocks/footer.php-->
        ...
        <div class="ft-bot">
            <div class="bot1"><img src="./public/images/logo.gif" /></div>
            <div class="bot2">
